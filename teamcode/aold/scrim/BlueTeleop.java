...
//
//public class BlueTeleop extends NrpOpMode {
//
...
////                ShooterConstants.SCORE_ANGLE);
////        double flywheelSpeed = Math.sqrt(g * x * x / (2 * Math.pow(Math.cos(hoodAngle), 2) * (x * Math.tan(hoodAngle) - y)));
////
////        //get robot velocity and convert into parallel and perpendicular
...
//                // location reset
//                if (gamepad1.x) {
//                    follower.setPose(new Pose(135.500, 10.00, Math.toRadians(0)));
//                    follower.update();
//                }
//
//
