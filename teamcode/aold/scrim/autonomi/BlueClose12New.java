...
//
//@Autonomous(name = "Blue  Close 12 - New")
//@Configurable
//public class BlueClose12New extends NrpOpMode {
//
...
//        follower.setStartingPose(new Pose(18.500, 118.700, Math.toRadians(145))); // Blue close start
//
...
//                            new BezierCurve(
//                                    new Pose(17.800, 59.200),
//                                    new Pose(28.423, 67.326),
//                                    new Pose(17.128, 68.595)
//                            )
//                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
//
//                    .build();
...
//                            new BezierCurve(
//                                    new Pose(17.128, 68.595),
//                                    new Pose(43.829, 66.187),
//                                    new Pose(49.268, 75.782),
//                                    new Pose(45.000, 95.500)
//                            )
//                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
//
//                    .build();
...
//                            new BezierCurve(
//                                    new Pose(45.000, 95.500),
//                                    new Pose(65.174, 80.888),
//                                    new Pose(42.399, 83.765),
//                                    new Pose(16.900, 83.500)
//                            )
//                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
//
//                    .build();
...
//                            new BezierCurve(
//                                    new Pose(45.000, 95.500),
//                                    new Pose(63.321, 34.099),
//                                    new Pose(46.814, 34.536),
...
//            case 0:
//                if (!pathStarted) {
//                    runShooterAtRPM(3550); //TODO: Fix RPM
...
//                    runShooterAtRPM(3500); //TODO: Fix RPM
//                }
//                if (!follower.isBusy()) {
//                    pathStarted = false;
//                    pathState = 5;
...
//                    pathStarted = true;
//                }
//                if ((pathTimer.milliseconds() >= 800) && (pathTimer.milliseconds() < 2300)) {
//                    Intake.setPower(-1);
//                    Transfer.setPower(-1);
//                }
//                if (pathTimer.milliseconds() >= 2300) {
//                    Transfer.setPower(0);
//                }
