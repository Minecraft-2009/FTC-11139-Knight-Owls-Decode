...
//        follower.setStartingPose(new Pose(89.800, 9.000, Math.toRadians(90))); // Blue close start
//
...
//                            new BezierLine(
//                                    new Pose(89.800, 9.000),
//
//                                    new Pose(89.800, 12.100)
//                            )
...
//
//                    if ((pathTimer.milliseconds() >= 5000) && (pathTimer.milliseconds() < 5300)) {
