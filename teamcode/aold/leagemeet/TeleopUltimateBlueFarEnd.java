...
@TeleOp(name = "F: Teleop Ultimate Blue (faR end); FAR AUTO")

public class TeleopUltimateBlueFarEnd extends NrpOpMode {
...
//todo
        ...
        follower.setStartingPose(new Pose(41.300, 20.000, Math.toRadians(155))); //TODO: Set for End of Auto
