...
@Configurable
public class BlueClose18 extends NrpOpMode {
...
//                //y= 0.0000000509332x^{4} - 0.0000184529x^{3} + 0.00241167x^{2} - 0.13161x + 3.29491
    ...
    public static class Paths {
        ...
        //todo
        double gateX = 20.551;// 123.7417 //start=124.902 => 1.1603
        double gateY = 63.24975; // 62.2669 //start=120.6888 => 58.4219
        double gateAngle = 158.052; //18.68 //start=32.732 => 14.052
        ...
        public Paths(Follower follower) {
            ...
            P1_2_Intake0300 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(45.200, 95.400),
                                    new Pose(46.492, 55.651),
                                    new Pose(52.271, 59.604),
            ...
            P2_ToTriShoot0606 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(17.800, 59.400),
                                    new Pose(39.972, 70.963),
                                    new Pose(57.700, 87.100)
                            )
            ...
            P3_OpenGateIntake0600 = follower.pathBuilder().addPath(
                    ...
                    ).setLinearHeadingInterpolation(Math.toRadians(160), Math.toRadians(gateAngle))
            ...
            P4_ToTriShoot0903 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(gateX, gateY),
                                    new Pose(39.964, 69.129),
                                    new Pose(57.800, 83.100)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(gateAngle), Math.toRadians(160))
            ...
            P6_ToTriShoot1203 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(gateX, gateY),
                                    new Pose(41.856, 67.673),
                                    new Pose(57.700, 82.900)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(gateAngle), Math.toRadians(160))
            ...
            P9_Intake1strow1203 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(57.700, 82.900),
                                    new Pose(37.018, 79.407),
                                    new Pose(18.100, 83.600)
                            )
