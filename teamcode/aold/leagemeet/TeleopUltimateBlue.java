...
@TeleOp(name = "Testing: Teleop Ultimate Blue (neAr end); WHEN END NEAR AUTO")

public class TeleopUltimateBlue extends NrpOpMode {
...
//todo
        ...
        follower.setStartingPose(new Pose(53.000, 108.000, Math.toRadians(150))); //TODO: Set for End of Auto
