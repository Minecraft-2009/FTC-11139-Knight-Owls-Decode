...
//@Configurable
//public class RedFarAuto extends NrpOpMode {  // ← Changed to LinearOpMode
//
...
//        follower.setStartingPose(new Pose(77, 10, Math.toRadians(90))); // Blue close start
//
...
//                    .pathBuilder()
//                    .addPath(
//                            new BezierLine(new Pose(77.000, 10.000), new Pose(77.000, 34.000))
//                    )
