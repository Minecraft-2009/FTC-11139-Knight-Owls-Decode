...
//
//@TeleOp(name = "Red Close - OneTeleop", group="Red")
//
//public class RedCloseOneTeleop extends NrpOpMode {
//
...
//        follower.setStartingPose(new Pose(108.000, 72.000, Math.toRadians(0))); // not center`
//        follower.update();
//
//
//        try {
