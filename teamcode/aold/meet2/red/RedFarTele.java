...
//
//@TeleOp(name = "RedFarTele", group="Red")
//
//public class RedFarTele extends NrpOpMode {
//
...
//        follower.setStartingPose(new Pose(77.000, 34.000, Math.toRadians(90))); // not center`
//        follower.update();
//
//
//        try {
...
//
//// Exact speaker sweet-spot (high basket) — this is the one every winning Decode bot uses right now
//                double targetX = 144.0;
//                double targetY = 130.0;        // NOT 144, NOT 96 — 141.0
//
//                double dx = targetX - turretX;
//                double dy = targetY - turretY;
//
